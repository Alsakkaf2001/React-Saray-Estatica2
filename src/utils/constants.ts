...
export const TREATMENTS: Treatment[] = [
  ...
  },
  {
    ...
    image: getTreatmentImage('zirconium-crowns'),
  ...
  },
  {
    ...
    image: getTreatmentImage('dental-veneers-emax'),
  ...
  },
  {
    ...
    image: getTreatmentImage('double-chin-liposuction'),
  ...
  // Hair Restoration
  {
    ...
    image: getTreatmentImage('sapphire-fue-hair-transplant'),
    price: 'Starting from €2,500',
    duration: '6-8 hours',
    category: 'hair-restoration',
