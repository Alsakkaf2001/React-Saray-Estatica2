  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container-custom relative z-20">
        <motion.div
          className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen lg:min-h-0"
        ...
        >
          {/* Left Content */}
          <motion.div
            className="text-white space-y-6 lg:space-y-8 text-center lg:text-left pt-20 lg:pt-0"
            variants={slideLeft}
          >
            ...
            {/* Subtitle */}
            <motion.p
              className="text-lg sm:text-xl md:text-2xl text-primary-100 leading-relaxed max-w-2xl mx-auto lg:mx-0"
              variants={fadeIn}
            ...
            >
              ...
              <Button
                ...
                className="text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 border-white text-white hover:bg-white hover:text-primary-600"
              >
                Watch Our Story
              </Button>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 bg-primary-300 rounded-full border-2 border-white"
                    />
                  ))}
                </div>
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="text-primary-100 text-sm ml-2">
                  4.9/5 Rating
                </span>
              </div>
            </motion.div>
