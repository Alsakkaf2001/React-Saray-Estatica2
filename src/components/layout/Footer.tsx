      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <motion.div variants={fadeIn} className="space-y-6">
            <div>
              <h3 className="text-2xl font-bold mb-4">Saray Estetic</h3>
          ...
          {/* Treatments */}
          <motion.div variants={fadeIn} className="space-y-6">
            <h4 className="text-xl font-semibold">Our Treatments</h4>
            <ul className="space-y-3">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-primary-200 focus:outline-none focus:ring-2 focus:ring-accent-400 focus:border-transparent"
                />
        ...
        <motion.div
          variants={fadeIn}
          className="mt-12 pt-8 border-t border-primary-500/30"
        >
